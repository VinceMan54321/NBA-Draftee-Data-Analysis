...
We will test preferences for picking guards and ask: Are more guards picked in the earlier draft round? Has the preference for guards shifted over time (is a greater proportion of guards picked in later years)? 
...
Null: The mean year of guards who were drafted is not different than that of non-guards (frontcourt players) who were drafted. 

Alternative: The mean year of guards who were drafted is different than that of non-guards (frontcourt players) who were drafted. 
